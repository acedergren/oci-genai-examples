  ...
  technical: {
    ...
    steps: [
      ...
      },
      {
        ...
        value: 'I need a web server in Frankfurt (eu-frankfurt-1) with 2 OCPUs and 16GB RAM running Oracle Linux 8 for a Node.js application.',
        talkingPoints: [
  ...
  costComparison: {
    ...
    steps: [
      ...
      },
      {
        ...
        action: 'type',
        selector: '.command-input input',
        value: 'Compare costs for 4 vCPU, 32GB RAM, 500GB storage, 100GB monthly egress, running 24/7 in Western Europe.',
      },
      {
        id: '6',
        title: 'Submit',
 ...
 */
export async function runExecutiveDemo(
  ctx: BrowserTestContext,
  options?: DemoRunnerOptions
) {
 ...
 */
export async function runCostComparisonDemo(
  ctx: BrowserTestContext,
  options?: DemoRunnerOptions
) {
