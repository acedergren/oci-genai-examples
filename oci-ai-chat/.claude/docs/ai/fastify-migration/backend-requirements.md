...
- [ ] The `@acedergren/oci-genai-query` package has TanStack Query fetchers that hardcode `/api/*` paths — will these need a configurable base URL when API lives on a different port?
