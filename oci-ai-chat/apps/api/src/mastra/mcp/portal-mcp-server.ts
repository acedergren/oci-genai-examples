...
import { AuthError, NotFoundError } from "@acedergren/portal-shared";
        ...
        contents: [
          {
            ...
            text: JSON.stringify({
              type: "workflows",
              description:
                "Use workflow APIs to manage workflow definitions and runs",
              endpoints: {
        ...
        contents: [
          {
            ...
            text: JSON.stringify({
              type: "search",
              description:
                "Semantic search using Oracle 26AI vector embeddings",
              endpoints: {
