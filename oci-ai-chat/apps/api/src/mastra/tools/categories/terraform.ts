...
export const terraformTools: ToolEntry[] = [
  {
    ...
    parameters: z.object({
      ...
      shape: z
        ...
        .describe(
          "Compute shape (e.g., VM.Standard.E4.Flex, VM.Standard.A1.Flex)",
        ),
      ocpus: z
        .number()
        .optional()
        .default(1)
        .describe("Number of OCPUs for flex shapes"),
      memoryGBs: z
        .number()
        .optional()
        .default(6)
        .describe("Memory in GB for flex shapes"),
      region: z
        .string()
        .optional()
