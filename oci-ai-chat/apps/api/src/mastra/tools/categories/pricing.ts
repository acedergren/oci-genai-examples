...
export const pricingTools: ToolEntry[] = [
  {
    ...
    parameters: z.object({
      ...
      egressGBPerMonth: z
        .number()
        .optional()
        .describe("Expected data egress in GB per month"),
      hoursPerMonth: z
        .number()
        .optional()
        .default(730)
  ...
  },
  {
    ...
    parameters: z.object({
      shapeName: z
        ...
        .optional()
        .describe(
          "Specific shape name (e.g., VM.Standard.E5.Flex, VM.Standard.A1.Flex)",
        ),
      architecture: z
        .enum(["x86", "arm", "gpu"])
        .optional()
      ...
      listAll: z
        .boolean()
        .optional()
        .describe("List all available shapes with pricing"),
    }),
    executeAsync: async (args) => {
      ...
      if (args.shapeName) {
        const pricing = await client.getComputePricing(
          args.shapeName as string,
        );
      ...
      return {
        error:
          "Please specify a shapeName, architecture, or set listAll to true",
      };
    },
  },
  {
    ...
    executeAsync: async (args) => {
      ...
      if (args.skuName) {
        const pricing = await client.getVMPricing(
          args.skuName as string,
          region,
        );
        if (!pricing)
          return {
  ...
  },
  {
    ...
    parameters: z.object({
      provider: z
        .enum(["oci", "azure", "aws"])
        .describe("Cloud provider to estimate costs for"),
      ...
      egressGBPerMonth: z
        .number()
        .optional()
        .describe("Data egress in GB per month"),
      hoursPerMonth: z
        .number()
        .optional()
        .default(730)
        .describe("Hours per month"),
    }),
    executeAsync: async (args) => {
      const service = new CloudPricingService();
  ...
  },
  {
    ...
    parameters: z.object({
      instanceType: z
        ...
        .optional()
        .describe(
          "Specific EC2 instance type (e.g., t3.micro, m5.large, c6g.large)",
        ),
      region: z
        .string()
        .optional()
      ...
      listAll: z
        .boolean()
        .optional()
        .describe("List all available instances with pricing"),
    }),
    executeAsync: async (args) => {
      ...
      if (args.instanceType) {
        const pricing = await client.getEC2Pricing(
      ...
      return {
        error:
          "Please specify an instanceType, architecture, or set listAll to true",
      };
    },
  },
];
