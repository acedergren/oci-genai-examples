...
export const computeTools: ToolEntry[] = [
  {
    ...
    execute: (args) => {
      ...
      if (args.lifecycleState)
        cliArgs.push("--lifecycle-state", args.lifecycleState as string);
  ...
  },
  {
    ...
    execute: (args) => {
      ...
      if (args.preserveBootVolume)
        cliArgs.push("--preserve-boot-volume", "true");
    ...
    execute: (args) => {
      ...
      if (args.operatingSystemVersion)
        cliArgs.push(
          ...
          args.operatingSystemVersion as string,
        );
  ...
  },
  {
    ...
    parameters: z.object({
      ...
      availabilityDomain: z
        .string()
        .optional()
        .describe("Filter by availability domain"),
    }),
    execute: (args) => {
      const compartmentId = requireCompartmentId(args);
      const cliArgs = [
