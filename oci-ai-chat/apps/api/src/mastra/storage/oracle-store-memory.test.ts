...
describe("MemoryOracle — Threads", () => {
  ...
  describe("getThreadById", () => {
    ...
    it("uses correct bind variable", async () => {
      ...
      const binds = mockConn.execute.mock.calls[0][1] as Record<
        string,
        unknown
      >;
  ...
  describe("updateThread", () => {
    ...
    it("throws when thread not found after update", async () => {
      ...
      await expect(
        mem.updateThread({ id: "missing", title: "T", metadata: {} }),
      ).rejects.toThrow("Thread not found after update");
    });
  });
...
describe("MemoryOracle — Messages", () => {
  ...
  describe("updateMessages", () => {
    ...
    it("throws when message not found", async () => {
      ...
      await expect(
        mem.updateMessages({ messages: [{ id: "missing" }] }),
      ).rejects.toThrow("Message not found for update");
    });
  });
});
...
describe("MemoryOracle — Resources", () => {
  ...
  describe("updateResource", () => {
    ...
    it("throws when resource not found after update", async () => {
      ...
      await expect(
        mem.updateResource({ resourceId: "gone", workingMemory: "x" }),
      ).rejects.toThrow("Resource not found after update");
    });
  });
});
