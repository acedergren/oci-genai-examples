...
import type { AgentPlan } from '$lib/components/panels/types.js';
  ...
  // Service categories for the portal — each action carries a context-aware prompt
  const serviceCategories = [
    {
      id: 'compute',
      title: 'Compute Resources',
      description: 'Virtual machines with flexible shapes — choose exact vCPUs, memory, and architecture (x86 or ARM)',
      icon: 'server',
      color: 'teal',
      actions: [
    ...
    },
    {
      ...
      description: 'Oracle Autonomous Database with built-in AI, vector search, and automatic patching',
      icon: 'database',
      color: 'indigo',
      actions: [
  ...
  // Quick actions — scenario-driven prompts that trigger multi-step advisory behavior
  const quickActions = [
  ...
  function handleServiceAction(action: { label: string; prompt: string }) {
